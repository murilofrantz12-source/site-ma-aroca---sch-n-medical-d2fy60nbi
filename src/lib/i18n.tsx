...
const SCRUB_FABRIC_COLORS_PT = [
  { name: 'Bordô', value: '#871143' },
  { name: 'Lilás', value: '#b77cc8' },
  { name: 'Azul profundo', value: '#09006f' },
  { name: 'Preto', value: '#050505' },
  { name: 'Pink Schön', value: '#d80b8c' },
  { name: 'Lavanda claro', value: '#dfcff7' },
...
const SCRUB_FABRIC_COLORS_EN = [
  ...
  { name: 'Soft coral', value: '#f8a6aa' },
  { name: 'Red', value: '#dc0000' },
  { name: 'Schön orange', value: '#ff5a0b' },
