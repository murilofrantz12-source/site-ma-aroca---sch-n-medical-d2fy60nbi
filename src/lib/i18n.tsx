...
const SCRUB_FABRIC_COLORS_PT = [
  { name: 'Bordô', value: '#9a174a' },
  { name: 'Lilás', value: '#b77cc8' },
  { name: 'Azul marinho', value: '#0b145c' },
  { name: 'Preto', value: '#050505' },
  { name: 'Pink', value: '#d80b8c' },
  { name: 'Lilás claro', value: '#dfcff7' },
  { name: 'Azul claro', value: '#94c7f2' },
  { name: 'Verde água', value: '#aef2e4' },
  { name: 'Rosa bebê', value: '#f6b1da' },
  { name: 'Rosa blush', value: '#f1d4dd' },
  { name: 'Azul frança', value: '#1e49b7' },
  { name: 'Azul petróleo', value: '#00616b' },
  { name: 'Verde oliva', value: '#425f43' },
  { name: 'Rosa velho', value: '#c88490' },
  { name: 'Vermelho', value: '#dc0000' },
  { name: 'Laranja', value: '#ff5a0b' },
  { name: 'Amarelo', value: '#ffe600' },
  { name: 'Branco', value: '#ffffff' },
]

const SCRUB_FABRIC_COLORS_ES = [
  { name: 'Bordó', value: '#9a174a' },
  { name: 'Lila', value: '#b77cc8' },
  { name: 'Azul marino', value: '#0b145c' },
  { name: 'Negro', value: '#050505' },
  { name: 'Pink', value: '#d80b8c' },
  { name: 'Lila claro', value: '#dfcff7' },
  { name: 'Azul claro', value: '#94c7f2' },
  { name: 'Verde agua', value: '#aef2e4' },
  { name: 'Rosa bebé', value: '#f6b1da' },
  { name: 'Rosa blush', value: '#f1d4dd' },
  { name: 'Azul Francia', value: '#1e49b7' },
  { name: 'Azul petróleo', value: '#00616b' },
  { name: 'Verde oliva', value: '#425f43' },
  { name: 'Rosa antiguo', value: '#c88490' },
  { name: 'Rojo', value: '#dc0000' },
  { name: 'Naranja', value: '#ff5a0b' },
  { name: 'Amarillo', value: '#ffe600' },
  { name: 'Blanco', value: '#ffffff' },
]

const SCRUB_FABRIC_COLORS_EN = [
  { name: 'Burgundy', value: '#9a174a' },
  { name: 'Lilac', value: '#b77cc8' },
  { name: 'Navy blue', value: '#0b145c' },
  { name: 'Black', value: '#050505' },
  { name: 'Pink', value: '#d80b8c' },
  { name: 'Light lilac', value: '#dfcff7' },
  { name: 'Light blue', value: '#94c7f2' },
  { name: 'Mint aqua', value: '#aef2e4' },
  { name: 'Baby pink', value: '#f6b1da' },
  { name: 'Blush pink', value: '#f1d4dd' },
  { name: 'French blue', value: '#1e49b7' },
  { name: 'Petrol blue', value: '#00616b' },
  { name: 'Olive green', value: '#425f43' },
  { name: 'Old rose', value: '#c88490' },
  { name: 'Red', value: '#dc0000' },
  { name: 'Orange', value: '#ff5a0b' },
  { name: 'Yellow', value: '#ffe600' },
  { name: 'White', value: '#ffffff' },
]

const SCRUB_RIBBON_COLORS_PT = [
  { name: 'Pink', value: '#ef2f92' },
  { name: 'Verde', value: '#b8f24a' },
  { name: 'Turquesa', value: '#0aaeba' },
  { name: 'Bege', value: '#b9bcb3' },
  { name: 'Lilás', value: '#b77cc8' },
  { name: 'Preto', value: '#101010' },
  { name: 'Branco', value: '#ffffff' },
  { name: 'Laranja', value: '#ff681f' },
  { name: 'Amarelo', value: '#ffe600' },
  { name: 'Vermelho', value: '#dc0000' },
  { name: 'Verde água', value: '#aef2e4' },
  { name: 'Rosa velho', value: '#c88490' },
...
const SCRUB_RIBBON_COLORS_ES = [
  { name: 'Pink', value: '#ef2f92' },
  { name: 'Verde', value: '#b8f24a' },
  { name: 'Turquesa', value: '#0aaeba' },
  { name: 'Beige', value: '#b9bcb3' },
  { name: 'Lila', value: '#b77cc8' },
  { name: 'Negro', value: '#101010' },
  { name: 'Blanco', value: '#ffffff' },
  { name: 'Naranja', value: '#ff681f' },
  { name: 'Amarillo', value: '#ffe600' },
  { name: 'Rojo', value: '#dc0000' },
  { name: 'Verde agua', value: '#aef2e4' },
  { name: 'Rosa antiguo', value: '#c88490' },
...
const SCRUB_RIBBON_COLORS_EN = [
  { name: 'Pink', value: '#ef2f92' },
  { name: 'Green', value: '#b8f24a' },
  { name: 'Turquoise', value: '#0aaeba' },
  { name: 'Beige', value: '#b9bcb3' },
  { name: 'Lilac', value: '#b77cc8' },
  ...
  pt: {
    ...
    schon: {
      ...
      customizer: {
        ...
        topColors: SCRUB_FABRIC_COLORS_PT,
        bottomColors: SCRUB_FABRIC_COLORS_PT,
        ribbonColors: SCRUB_RIBBON_COLORS_PT,
        labelColors: SCRUB_RIBBON_COLORS_PT,
        ...
        models: [
          ...
          },
          {
            ...
            topDetails: 'Bolso inferior lateral simples em ambos os lados.',
            bottomDetails:
              'Bolso superior lateral simples em ambos os lados, bolso inferior lateral simples em ambos os lados, tipo jogger.',
            topPrice: 'R$ 100',
            bottomPrice: 'R$ 120',
            setPrice: 'R$ 220',
            deliveryFee: 'R$ 65',
  ...
  es: {
    ...
    schon: {
      ...
      customizer: {
        ...
        topColors: SCRUB_FABRIC_COLORS_ES,
        bottomColors: SCRUB_FABRIC_COLORS_ES,
        ribbonColors: SCRUB_RIBBON_COLORS_ES,
        labelColors: SCRUB_RIBBON_COLORS_ES,
        sizes: ['PP', 'P', 'M', 'G', 'GG', 'XG', 'EXG', 'EXGG'],
        models: [
          {
            name: 'Classic',
            ...
            topDetails: 'Corte recto.',
            bottomDetails: 'Bolsillo superior lateral simple en ambos lados, corte recto.',
            topPrice: 'Gs. 80.000',
          ...
          },
          {
            ...
            topDetails: 'Bolsillo inferior lateral simple en ambos lados.',
            bottomDetails:
              'Bolsillo superior lateral simple en ambos lados, bolsillo inferior lateral simple en ambos lados, tipo jogger.',
            topPrice: 'Gs. 100.000',
          ...
          },
          {
            ...
            topDetails:
              'Bolsillo inferior lateral simple del lado izquierdo, bolsillo inferior lateral doble del lado derecho, bolsillo superior del lado izquierdo y abertura lateral de 4 cm.',
            bottomDetails:
              'Bolsillo superior lateral simple del lado derecho, bolsillo superior lateral con cierre del lado izquierdo, bolsillo inferior lateral simple del lado izquierdo, bolsillo inferior lateral doble del lado derecho y corte recto.',
            topPrice: 'Gs. 120.000',
  ...
  en: {
    ...
    schon: {
      ...
      customizer: {
        ...
        topColors: SCRUB_FABRIC_COLORS_EN,
        bottomColors: SCRUB_FABRIC_COLORS_EN,
        ribbonColors: SCRUB_RIBBON_COLORS_EN,
        labelColors: SCRUB_RIBBON_COLORS_EN,
        sizes: ['PP', 'P', 'M', 'G', 'GG', 'XG', 'EXG', 'EXGG'],
        models: [
          {
            name: 'Classic',
            ...
            topDetails: 'Straight cut.',
            bottomDetails: 'Simple upper side pocket on both sides, straight cut.',
            topPrice: 'US$ 16',
            bottomPrice: 'US$ 21',
            setPrice: 'US$ 37',
            deliveryFee: 'US$ 12',
          },
          {
            ...
            topDetails: 'Simple lower side pocket on both sides.',
            bottomDetails:
              'Simple upper side pocket on both sides, simple lower side pocket on both sides, jogger style.',
            topPrice: 'US$ 20',
            bottomPrice: 'US$ 24',
            setPrice: 'US$ 44',
            deliveryFee: 'US$ 12',
          },
          {
            ...
            topDetails:
              'Simple lower side pocket on the left, double lower side pocket on the right, upper pocket on the left and 4 cm side opening.',
            bottomDetails:
              'Simple upper side pocket on the right, upper side pocket with zipper on the left, simple lower side pocket on the left, double lower side pocket on the right and straight cut.',
            topPrice: 'US$ 23',
            bottomPrice: 'US$ 27',
            setPrice: 'US$ 50',
            deliveryFee: 'US$ 12',
