  ...
  pt: {
    ...
    schon: {
      ...
      customizer: {
        ...
        intro:
          'Escolha cores, tamanho, tecido, fitas e etiqueta. No final, envie a composição pronta para receber um orçamento personalizado.',
        ...
        steps: {
          ...
          labelColor: 'Cor da etiqueta',
          size: 'Tamanho',
          fabric: 'Tipo de tecido',
          embroidery: 'Personalização',
        },
        topColors: [
          { name: 'Preto', value: '#111111' },
          { name: 'Branco', value: '#f8f8f4' },
          { name: 'Rosa claro', value: '#f8b9d2' },
          { name: 'Pink Schön', value: '#f43b91' },
          { name: 'Laranja', value: '#ff6a1a' },
          { name: 'Amarelo', value: '#f4e633' },
          { name: 'Azul royal', value: '#2446b8' },
          { name: 'Azul marinho', value: '#182545' },
          { name: 'Vinho', value: '#681b2b' },
        ],
        bottomColors: [
          { name: 'Preto', value: '#111111' },
          { name: 'Branco', value: '#f8f8f4' },
        ...
        fabrics: [
          {
            name: 'Essencial',
            desc: 'Boa estrutura para rotina diária e ótimo custo-benefício.',
          },
          {
            name: 'Comfort',
            desc: 'Toque mais macio, boa mobilidade e caimento equilibrado.',
          },
          {
            name: 'Premium',
            desc: 'Melhor tecido da linha, com acabamento superior e mais presença.',
          },
        ],
  ...
  es: {
    ...
    schon: {
      ...
      customizer: {
        ...
        intro:
          'Elige colores, talle, tela, cintas y etiqueta. Al final, envía la composición lista para recibir un presupuesto personalizado.',
        ...
        topColors: [
          ...
          { name: 'Blanco', value: '#f8f8f4' },
          { name: 'Rosa claro', value: '#f8b9d2' },
          { name: 'Pink Schön', value: '#f43b91' },
          { name: 'Naranja', value: '#ff6a1a' },
          { name: 'Amarillo', value: '#f4e633' },
          { name: 'Azul royal', value: '#2446b8' },
          { name: 'Azul marino', value: '#182545' },
          { name: 'Vino', value: '#681b2b' },
        ],
        bottomColors: [
          { name: 'Negro', value: '#111111' },
          { name: 'Blanco', value: '#f8f8f4' },
        ...
        fabrics: [
          {
            name: 'Esencial',
            desc: 'Buena estructura para la rutina diaria y excelente costo-beneficio.',
          },
          {
            name: 'Comfort',
            desc: 'Toque más suave, buena movilidad y calce equilibrado.',
          },
          {
            name: 'Premium',
            desc: 'La mejor tela de la línea, con terminación superior y más presencia.',
          },
        ],
  ...
  en: {
    ...
    schon: {
      ...
      customizer: {
        ...
        intro:
          'Choose colors, size, fabric, ribbons and label. At the end, send the complete composition to receive a personalized quote.',
        ...
        topColors: [
          ...
          { name: 'Light pink', value: '#f8b9d2' },
          { name: 'Schön Pink', value: '#f43b91' },
          { name: 'Orange', value: '#ff6a1a' },
          { name: 'Yellow', value: '#f4e633' },
          { name: 'Royal blue', value: '#2446b8' },
          { name: 'Navy blue', value: '#182545' },
          { name: 'Burgundy', value: '#681b2b' },
        ],
        bottomColors: [
          { name: 'Black', value: '#111111' },
          { name: 'White', value: '#f8f8f4' },
        ...
        fabrics: [
          {
            name: 'Essential',
            desc: 'Good structure for daily routines and strong value.',
          },
          {
            name: 'Comfort',
            desc: 'Softer touch, good mobility and balanced fit.',
          },
          {
            name: 'Premium',
            desc: 'The best fabric in the line, with superior finishing and more presence.',
          },
        ],
